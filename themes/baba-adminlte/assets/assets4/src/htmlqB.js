...
.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    $stateProvider
        ...
        .state('root', {
            'abstract': true,
            controller: 'RootCtrl',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/root.html',
            resolve: {
                'language': ['$http', '$sce', function($http, $sce) {
                    return $http.get('http://plataformaq.unsa.edu.ar/lang/{text name="idioma" label="idioma"}1{/text}', {
                ...
                'statements': ['$http', '$sce', function($http, $sce) {
                    ...
                    return $http.get('http://plataformaq.unsa.edu.ar/xml/{text name="websiteName" label="Website Name"}numero{/text}/{text name="idioma" label="idioma"}1{/text}', {
                        transformResponse: xml2json
                    }).then(function(data, status) {
                ...
                'map': ['$http', function($http) {
                    return $http.get('http://plataformaq.unsa.edu.ar/map/{text name="websiteName" label="Website Name"}numero{/text}', {
                        transformResponse: xml2json
                    }).then(function(data, status) {
                ...
                'config': ['$http', function($http) {
                    return $http.get('http://plataformaq.unsa.edu.ar/config/{text name="websiteName" label="Website Name"}numero{/text}', {
                        transformResponse: xml2json
                    }).then(function(data, status) {
        ...
        .state('root.welcome', {
            url: '/?userCode',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/empty.html',
        ...
        .state('root.login', {
            url: '/login',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/login.html',
        ...
        .state('root.step1', { // 3 columns
            url: '/step1',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/step1.html',
        ...
        .state('root.step2', { // +- grid
            url: '/step2',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/step2.html',
        ...
        .state('root.step3', { // reorder grid
            url: '/step3',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/step3.html',
        ...
        .state('root.step4', { // comments for best and worst rating
            url: '/step4',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/step4.html',
        ...
        .state('root.step5', { // demographics or questionnaire
            url: '/step5',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/step5.html',
        ...
        .state('root.submit', { // demographics or questionnaire
            url: '/submit?retry',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/submit.html',
            controller: 'SubmitCtrl',
            warnOnClose: true
        })
        .state('root.print', { // demographics or questionnaire
            url: '/print',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/print.html',
            controller: 'PrintCtrl',
            warnOnClose: true
        })
        .state('root.thanks', { // demographics or questionnaire
            url: '/thanks',
            templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/thanks.html',
...
.directive('swappableStatement', ['$log', function($log) {
    return {
        ...
        templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/_swappable_statement.html',
        link: function(scope, element, attrs) {
    ...
    return {
        show: function(messageHead, message, textAlign, ok) {
            return modalInstance = $modal.open({
                templateUrl: 'http://plataformaq.unsa.edu.ar/themes/baba-adminlte/assets/assets4/templates/modal.html',
